...
import verificar_criterios_gauss_seidel as verificar
import sys
...
if verificar.is_convergente == False:
    ...
    print('O sistema não cumpre os critérios de Gauss-Seidel.')
    sys.exit()
...
for x0 in x0_valores:
    solucao, erros = gauss_seidel(sysL.A, sysL.b, x0)
